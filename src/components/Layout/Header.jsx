        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="md:hidden flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="bg-black rounded-xl p-2 flex items-center justify-center shadow-lg hover:bg-gray-800 transition-colors flex-shrink-0 min-w-[48px] min-h-[48px]"
              aria-label="Toggle menu"
              id="mobile-menu-toggle-button"
            >
              <ChevronDown
                className={`w-8 h-8 text-white transition-transform duration-200 ${mobileMenuOpen ? "rotate-180" : ""}`}
              />
            </button>
          </div>
        </div>
