        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="md:hidden flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="bg-black rounded-xl p-4 md:p-3 flex items-center justify-center shadow-lg hover:bg-gray-800 transition-colors flex-shrink-0 min-w-[48px] h-full min-h-16 md:min-h-[48px] md:h-auto"
